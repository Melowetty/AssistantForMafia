...
val SettingsDescription = Color(0xFFE6D5D5)
...
val DeepOcean = Color(0xFF335387)
val LightBlue = Color(0xFF1F6FC2)

val DarkBackground = Color(red = 0f, green = 0f, blue = 0f, alpha = 0.65f)
val PopupBackground = DarkGreen
val MainBackground = DarkGreen
val SecondaryBackground = DarkBlue
...
val EnemyRoleBackgroundColor = Color(0xFFC21F2E)
